<template>
  <div class="grid gap-3.5 stagger-in">
    <section class="fd-card grid gap-3 rounded-2xl p-3">
    ...
    <section v-if="sessionMode === 'quick'" class="fd-card grid gap-2 rounded-2xl p-3">
      <p class="fd-section-label inline-flex items-center gap-1.5">
    ...
    <section class="fd-card grid gap-2.5 rounded-2xl p-3">
      <div class="flex items-center justify-between gap-2">
      ...
      <Transition name="expand-fade">
        <div v-if="isAdvancedControlsOpen" id="advanced-controls-panel" class="grid gap-2">
          <section class="fd-subtle-card grid gap-1.5 rounded-xl p-3">
